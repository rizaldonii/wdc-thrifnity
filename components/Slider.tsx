...
export default function ModernSlider({
  ...
  return (
    ...
    >
            ...
            <div className="relative h-full w-full overflow-hidden">
              ...
              >
                ...
                {slide.ctaText && slide.ctaLink && (
                  <a
                    href={slide.ctaLink}
                    className="px-6 py-3 bg-white text-black font-medium rounded-full hover:bg-white/90 transition-all transform hover:scale-105 shadow-lg"
                  >
                    {slide.ctaText}
                  </a>
                )}
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-md text-white p-3 rounded-full hover:bg-white/30 transition-all transform hover:scale-110 z-20 group"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-md text-white p-3 rounded-full hover:bg-white/30 transition-all transform hover:scale-110 z-20 group"
